...
chrome.storage.sync.get(["on"]).then((result) => {
  ...
  //if (title_text)
      ...
      if (true){
        ...
        sdd_open.classList.add("btn", "btn-secondary", "btn-sm", "float-end", "bg-attalos", "border-attalos");
        sdd_open.textContent = "Open listing in SDD";
        sdd_open.id = "sdd_open"

        sdd_open.href = "https://attalosagency.com/out/index.php?url=https://partner.bol.com/sdd/product-content/product/" + ean;
        ...
        card.classList.add("card", "mb-3", "w-50", "h-100", "no-border")
